...
async function setup() {
  ...
  const order1 = await Orders.create({purchasedby: "meganbuyer", soldby: "meganseller", listingid: "1"})
  const order2 = await Orders.create({purchasedby: "meganbuyer", soldby: "meganseller", listingid: "2"})
  const order3 = await Orders.create({purchasedby: "meganbuyer", soldby: "meganseller", listingid: "3"})
}
