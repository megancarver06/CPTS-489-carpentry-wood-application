CREATE TABLE IF NOT EXISTS BUYER ( username TEXT PRIMARY KEY NOT NULL, password TEXT NOT NULL, firstname TEXT NOT NULL );

CREATE TABLE IF NOT EXISTS SELLER ( storename TEXT PRIMARY KEY NOT NULL, username TEXT NOT NULL, password TEXT NOT NULL );

CREATE TABLE IF NOT EXISTS ADMIN ( username TEXT PRIMARY KEY NOT NULL, password TEXT NOT NULL, firstname TEXT NOT NULL );
...
INSERT INTO ADMIN VALUES ('meganadmin', '1234', 'Megan');
INSERT INTO ADMIN VALUES ('brianaadmin', '1234', 'Briana');
INSERT INTO ADMIN VALUES ('albertadmin', '1234', 'Albert');

INSERT INTO SELLER VALUES ('meganseller', '1234', 'Megan');

INSERT INTO BUYER VALUES ('TimberTreasures', 'meganseller', '1234');
